...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post workshops_url, params: { workshop: { availability: @workshop.availability, calendar: @workshop.calendar, description: @workshop.description, event_id: @workshop.event_id, vacancies: @workshop.vacancies } }
    end
  ...
  test "should update workshop" do
    patch workshop_url(@workshop), params: { workshop: { availability: @workshop.availability, calendar: @workshop.calendar, description: @workshop.description, event_id: @workshop.event_id, vacancies: @workshop.vacancies } }
