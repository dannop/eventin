...
class LotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lot" do
    assert_difference('Lot.count') do
      post lots_url, params: { lot: { event_id: @lot.event_id, price: @lot.price, ticket: @lot.ticket } }
    end
  ...
  test "should update lot" do
    patch lot_url(@lot), params: { lot: { event_id: @lot.event_id, price: @lot.price, ticket: @lot.ticket } }
